...
const HELP =
  "Use /start to open the library menu. Browse sections, search by words or tags, and save favorites.\n\n" +
  "Content controls are available from the Content admin button.";
